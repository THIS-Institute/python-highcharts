...
class Highchart(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.JSsource = [
                ...
                'https://code.highcharts.com/7.0/highcharts.js',
                'https://code.highcharts.com/7.0/highcharts-more.js',
                'https://code.highcharts.com/7.0/modules/heatmap.js',
                'https://code.highcharts.com/7.0/modules/exporting.js'
            ]
    ...
    def buildcontent(self):
        ...
        options['series'] = [i.data for i in self.data_temp][0]
